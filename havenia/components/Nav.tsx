  ...
  return (
    <header className="top-0 z-40 text-white bg-transparent pt-4 pl-2 pr-2">
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-4">
        <Link href="/" className="font-semibold"><img className='w-[80px]' src='/image.png' alt="" /></Link>
        ...
        <div className="md:hidden fixed inset-0 z-50">
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <Link href="/"><img className='w-[80px]' src='/image2.png' alt="" /></Link>
              <button
            ...
            <Link href="/activities" onClick={() => setOpen(false)} className="py-2">Activities</Link>
            <Link href="/rooms" onClick={() => setOpen(false)} className="py-2">Rooms</Link>
            ...
            {authed ? (
              <>
                <Link href="/me/profile" onClick={() => setOpen(false)} className="py-2">
                  Profile
                </Link>
                <button
